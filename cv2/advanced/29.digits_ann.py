...
def load_data():
    """ Load the MNIST data set from the mnist.pkl.gz file
    """
...
def wrap_data():
    """ Wrap the data into the format needed for the ANN
    """
    tr_d, te_d = load_data()
...
def create_ann(hidden_nodes=60):
    """ Create an ANN with 784 input nodes, 20 hidden nodes and 10 output nodes
    """
...
def train(ann, samples=50000, epochs=10):
    """ Train the ANN on the MNIST data set
    """
    tr, test = wrap_data()
