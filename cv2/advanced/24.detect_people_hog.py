...
def is_inside(i, o):
    """ Check if rectangle i is inside rectangle o
    """
    ix, iy, iw, ih = i
    ox, oy, ow, oh = o
...
# Set the support vector machine to the default people detector
...
# Filter out the rectangles that are inside other rectangles
