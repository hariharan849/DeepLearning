...
def compute_energy_matrix(img): 
    """ Compute the energy matrix of the image as the sum of the 
    absolute gradient in the x and y directions.
    ...
    # Return the energy matrix as the sum of the absolute gradients
...
if __name__=='__main__': 
    img_input = cv2.imread("/content/sample_data/ducks.jpg") 
    num_seams = int(20) 
