...
image = cv2.imread('/content/sample_data/1605897531487.jpg')
...
all_contours, hierarchy = cv2.findContours(edged.copy(), cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)
...
cnts = sorted(all_contours, key = cv2.contourArea, reverse = True)[:5]
